<template>
    <v-container fluid>
        ...
        <v-row class="no-break">
            ...
            <v-col>
                <Experience :print="true"></Experience>
            </v-col>
        </v-row>

        <v-row class="no-break">
            <v-col>
                <Education :print="true"></Education>
            </v-col>
        </v-row>

        <v-row class="no-break">
            <v-col>
                <Skill :print="true"></Skill>
            </v-col>
        </v-row>
...
import PdfLanguages from '~/components/PdfLanguages.vue';
